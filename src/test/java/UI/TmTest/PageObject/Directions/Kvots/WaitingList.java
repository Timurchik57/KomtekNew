...
public class WaitingList extends BaseTest {
    /**
     * Направления - Лист ожидания
     */
    public WaitingList (WebDriver driver) {
     ...
     * Направления - Лист ожидания
     */
    public By WaitingListWait = By.xpath("//li//a[@href='/direction/unhandled?directionType=1&directionTarget=3&directionPageType=1']");
